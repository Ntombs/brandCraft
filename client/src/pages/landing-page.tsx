        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div>
            <h1 className="text-4xl md:text-5xl font-playfair font-bold leading-tight mb-6">
              Strategic Brand Construction &<br />Graphic Design
            </h1>
            <p className="text-gray-700 mb-8 text-lg">
              Nompo Evelyn specializes in comprehensive brand development, from visual identity design to strategic positioning and compliance solutions.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="border border-gray-200 p-6 rounded-lg">
              ...
              <p className="text-gray-600">
                Ensuring your brand meets industry regulations and standards while maintaining its unique identity.
              </p>
            </div>
          </div>
        </div>
